...
public class FunctionalInterfaceDemo {
    ...
    private static void print(Supplier<String> supplier) {
        if (errorFlag) {
            ...
            //this string concatenation will not happen if errorFlag is false;
            // because of Supplier functional interface won't execute the lambda
            // until supplier.get() called.
        }
    }
